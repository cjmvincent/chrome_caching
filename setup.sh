...
DEBIAN_FRONTEND=noninteractive apt install -y sudo curl nginx libnginx-mod-stream unattended-upgrades
...
# ======================================================================
# Backup default NGINX config, copy over cache config, and then restart the service
